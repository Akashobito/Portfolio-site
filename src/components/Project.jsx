...
function Project() {
  ...
  return (
    ...
    >
      <p className="text-2xl font-bold lg:text-4xl">PROJECTS</p>
      <div  onClick={handleScrollTOp} className={isScrolltop? "mb-[-12px] px-1 py-2 mt-5 rounded-full bg-[#104050] text-white flex items-center cursor-pointer lg:hidden":"px-1 py-2 rounded-full bg-[#104050] text-white flex items-center mt-3 cursor-pointer lg:hidden opacity-0 hover:cursor-auto"}>
        <i
          className="fa-solid fa-arrow-down fa-flip-vertical text-sm"
        ></i>
      </div>
      <div
        ref={ref}
      ...
      <div onClick={handleScrollDown} className={!isScrolltop? "mt-[-12px] px-1 py-2 rounded-full bg-[#104050] text-white flex items-center cursor-pointer lg:hidden":"px-1 py-2 rounded-full bg-[#104050] text-white flex items-center mt-3 cursor-pointer lg:hidden opacity-0 hover:cursor-auto"}>
        <i
          ...
          className="fa-solid fa-arrow-down text-sm"
        ></i>
      </div>
