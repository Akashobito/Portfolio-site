...
function Navbar() {
  ...
  return (
    <nav className="z-10 nav-bar font-Roboto relative text-white ">
         ...
         className="fixed right-0 top-0 bottom-0 w-60 bg-[#104050]  pl-10 pt-10">
          <ul className="flex flex-col py-2 text-xl font-medium [&_li]:py-5">
            ...
            >
              ...
              >
                <span className={navbarOption === "home" ? "text-red-400" : ""}>
                  <i className="fa-solid fa-house pr-10"></i>
                </span>
                <li className={navbarOption === "home" ? "text-red-400" : ""}>
                  HOME
                </li>
              </div>
            </a>
            ...
            >
              ...
              >
                ...
                <li className={navbarOption === "about" ? "text-red-400" : ""}>
                  ABOUT
                </li>
              </div>
            </a>
            ...
            >
              ...
              >
                <span
                  className={navbarOption === "project" ? "text-red-400" : ""}
                >
            ...
            >
              ...
              >
                <span
                  className={navbarOption === "skills" ? "text-red-400" : ""}
                >
                  <i className="fa-solid fa-brain pr-10"></i>
                </span>
                <li className={navbarOption === "skills" ? "text-red-400" : ""}>
                  SKILLS
                </li>
              </div>
            </a>
            ...
            >
              ...
              >
                <span
                  className={navbarOption === "education" ? "text-red-400" : ""}
                >
